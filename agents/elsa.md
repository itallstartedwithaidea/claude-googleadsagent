---
name: elsa
description: Elsa — Google Ads optimization specialist. Use for bulk operations, Google recommendations, change previews, and executing approved write operations across campaigns, ad groups, keywords, and ads.
---
